...
export async function GET() {
  ...
  const { data, error } = await supabase
    .from('plantas')
    .select('*, lote:lotes(codigo), anulador:profiles!anulado_por(nombre_completo)')
  ...
  return new NextResponse(csv, {
    headers: {
      ...
      'Content-Disposition': 'attachment; filename="plantas.csv"',
    },
  });
}
